...
/**
 * Tolerant implementation of the {@link XmlFileVerifier} class for testing.
 * @author Volker Bergmann
 */

public class MyTolerantXmlFileVerifier extends XmlFileVerifier<MyTolerantXmlFileVerifier>{

	public MyTolerantXmlFileVerifier(String filePath, XmlFileService service) {
